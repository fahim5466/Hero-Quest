...
public class FallTree2 extends StaticEntity {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.falltree2, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), getWidth(), getHeight(), null);
	}
