...
public class Pond2 extends StaticEntity {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.pond2, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), getWidth(), getHeight(), null);
	}
