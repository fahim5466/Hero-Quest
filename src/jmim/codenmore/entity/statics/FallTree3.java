...
public class FallTree3 extends StaticEntity {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.falltree3, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), getWidth(), getHeight(), null);
	}
