...
public class Forest extends StaticEntity {
	...
	public Forest(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.forest, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), getWidth(), getHeight(), null);
	}
