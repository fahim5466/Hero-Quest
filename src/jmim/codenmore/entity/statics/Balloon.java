...
public class Balloon extends StaticEntity {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.balloon, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), getWidth(), getHeight(), null);
	}
