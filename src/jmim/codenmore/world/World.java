...
public class World {
	...
	public World(Handler handler,String path)
	{
		...
		entityManager.addEntity(new Tree2(handler, 16*22, 16*58));
		entityManager.addEntity(new Tree2(handler, 16*50, 16*57));
		entityManager.addEntity(new Tree2(handler, 16*55, 16*30));
		entityManager.addEntity(new Tree2(handler, 16*55, 16*47));
		entityManager.addEntity(new Tree2(handler, 16*45, 16*47));
		entityManager.addEntity(new Tree2(handler, 16*49, 16*44));
		entityManager.addEntity(new Tree2(handler, 16*40, 16*44));
		entityManager.addEntity(new Tree2(handler, 16*30, 16*50));
		entityManager.addEntity(new Tree2(handler, 16*37, 16*54));
		
		
		
		entityManager.addEntity(new WeirdGrass(handler, 16*35, 16*42));
		entityManager.addEntity(new WeirdGrass(handler, 16*37, 16*44));
		//entityManager.addEntity(new WeirdGrass(handler, 16*40, 16*47));
