...
public class Assets {
	...
	public static void load()
	{
		...
		SpriteSheet playerMagicRight = new SpriteSheet(ImageLoader.loadImage("/Textures/playerMagicRight.png"),128,128);
		
		SpriteSheet playerAttackDown = new SpriteSheet(ImageLoader.loadImage("/Textures/playerAttackDown.png"),128,128);
		SpriteSheet playerAttackUp = new SpriteSheet(ImageLoader.loadImage("/Textures/playerAttackUp.png"),128,128);
		SpriteSheet playerAttackLeft = new SpriteSheet(ImageLoader.loadImage("/Textures/playerAttackLeft.png"),128,128);
		SpriteSheet playerAttackRight = new SpriteSheet(ImageLoader.loadImage("/Textures/playerAttackRight.png"),128,128);
		...
		baseFont = FontLoader.loadFont("res/Fonts/Alagard.ttf", 20);
		...
		Image dfault = toolkit.getImage("F:/Eclipse workspace/TileGame/res/Textures/cursor.png");
		Image interact = toolkit.getImage("F:/Eclipse workspace/TileGame/res/Textures/cursor2.png");
