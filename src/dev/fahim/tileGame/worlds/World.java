...
public class World {
	...
	public World(Handler handler, String path, Player player) {
		 ...
		 * IMPORTANT!!
		 * 
		 * Unfortunately because of how short-path finding code works every entity who
		 * needs it must be placed such that its entire collision box fits inside a
		 * single tile
		 * 
		 */
	}
	...
	private void loadWorld(String path) {
		 ...
		 * System.out.print(tiles[i][j]+" "); } System.out.print("\n"); }
		 * System.out.print("\n");
		 */
	}
